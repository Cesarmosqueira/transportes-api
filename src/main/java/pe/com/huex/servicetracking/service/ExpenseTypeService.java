    ...
    public ResponseDto<ExpenseTypeListResponse> listExpenseType() {
        ...
        try {
            ...
            response.setDatos(new ExpenseTypeListResponse()
                    .expenseTypeListResponse(expenseTypeMapping.modelList(expenseTypeList)));
    ...
    public ResponseDto<ExpenseTypeRegisterResponse> registerExpenseType(ExpenseTypeDto expenseTypeDto) {
        ...
        try {
            ...
            response.meta(MetaDatosUtil.buildMetadatos(CODE_SUCCESS, MESSAGE_REGISTER_EXPENSETYPE_SUCCESS, INFO,
                    idTransaccion));
            response.setDatos(new ExpenseTypeRegisterResponse()
                    .expenseTypeRegisterResponse(expenseTypeMapping.modelDto(expenseTypeResponse)));
        } catch (Exception ex) {
